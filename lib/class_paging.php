	...
	function navHalaman($halaman_aktif, $jmlhalaman){
		...
		for ($i=1; $i<=$jmlhalaman; $i++){
			if ($i == $halaman_aktif){
				...
				$link_halaman .= "<a href=admin.php?p=produk_l&halaman=$i>$i</a> | ";
			}
		$link_halaman .= " ";
		}
	return $link_halaman;
	...
	function navHalaman2($halaman_aktif, $jmlhalaman){
		...
		for ($i=1; $i<=$jmlhalaman; $i++){
			if ($i == $halaman_aktif){
				...
				$link_halaman .= "<a href=admin.php?p=kota_l&halaman=$i>$i</a> | ";
			}
		$link_halaman .= " ";
		}
	return $link_halaman;
	...
	function navHalaman3($halaman_aktif, $jmlhalaman){
		...
		for ($i=1; $i<=$jmlhalaman; $i++){
			if ($i == $halaman_aktif){
				...
				$link_halaman .= "<a href=admin.php?p=kategori_l&halaman=$i>$i</a> | ";
			}
		$link_halaman .= " ";
		}
	return $link_halaman;
